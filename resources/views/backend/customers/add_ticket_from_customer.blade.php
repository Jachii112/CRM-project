                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="customer_number" class="form-select" id="customer_number"
                                        readonly value="{{ $customerNumber }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control customer-name" id="customer_name"
                                        name ="customer_name" readonly value="{{ $customerName }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control contact-number" id="contact_number"
                                        name ="contact_number" readonly value="{{ $phoneNumber }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="email" class="form-control email-address" id="email_address"
                                        name="email_address" readonly value="{{ $customerEmail }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
