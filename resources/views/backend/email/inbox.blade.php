...
@section('admin')
                            ...
                            <tbody>
                                @foreach ($customerAppointment as $appointment)
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-warning register-customer-button"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const registerCustomerButtons = document.querySelectorAll('.register-customer-button');

            registerCustomerButtons.forEach(button => {
