...
Route::middleware(['auth', 'role:admin'])->group(function(){
    ...
    Route::get('/add/customer/{id}', [AdminController::class,'AddCustomerFromInbox'])->name('add.customer.inbox');
    Route::post('/register/customer', [AdminController::class, 'registerCustomer'])->name('register.customer');
});
