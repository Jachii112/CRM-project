...
Route::middleware(['auth', 'role:admin'])->group(function(){
    ...
    Route::get('/events/list', [AdminController::class,'AdminEvent'])->name('events.list');
    Route::get('/', [AdminController::class,'createEvent'])->name('events.create');
    Route::post('/', [AdminController::class,'storeEvent'])->name('events.store');
...
Route::middleware(['auth', 'role:admin'])->group(function(){
    Route::get('/admin/compose', [EmailController::class,'composedMail'])->name('compose.email');
...
Route::middleware(['auth', 'role:admin'])->group(function(){
    Route::controller(CustomerController::class)->group(function(){
        ...
        Route::get('/Customer/AddTickets', 'addTicketFromCustomer')->name('add.ticket.from.customer');
    });
});
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    Route::controller(PurchaseOrderController::class)->group(function () {
        ...
        Route::post('/complete-order/{order_no}', 'completeOrder')->name('complete.order');
    });
});
