...
class AdminController extends Controller
{
    ...
    public function AdminInbox()
    {
        ...
        $customerName = $customerAppointment->first()->customerName;
        return view('backend.email.inbox', compact('customerAppointment', 'customerName'));
    }
...
{
    // Get the customerName data from the request
    $customerName = $request->query('customerName');

    // Pass the customerName data to the view
    return view('backend.email.add_customer_from_inbox', ['customerName' => $customerName]);
}
}
