...
class AdminController extends Controller
{
    ...
    public function AddCustomerFromInbox($id)
    {
        $addCustomer = WebsiteServiceAppointment::findOrFail($id);
        return view('backend.customers.add_customer_from_inbox', compact('addCustomer'));
    }
