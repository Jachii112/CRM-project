...
<body>
    ...
    <div class="container">
        <!--MENU BAR CONTAINER-->
        <div class="menu-bar">
            <img class="logo" src="image/logoawes.png" alt="AWES">
                    ...
                    <div class="inner">
                        <div class="slide slide_1">
                            <div class="slide-content">
                                <img class="ser-img" alt="service-intro" src="./image/slider1.jpg">
                            </div>
                        </div>
                        <div class="slide slide_2">
                            <div class="slide-content">
                                <img class="ser-img" alt="service-intro" src="./ImagesAssets/2.jpg">
                            </div>
                        </div>
                        <div class="slide slide_3">
                            <div class="slide-content">
                                <img class="ser-img" alt="service-intro" src="./ImagesAssets/3.png">
                            </div>
                        </div>
                        <div class="slide slide_4">
                            <div class="slide-content">
                                <img class="ser-img" alt="service-intro" src="./ImagesAssets/13.jpg">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="service-mid-container">
            ...
            <div class="ventilation-container">
                <img src="./image/image-removebg.png" alt="ventilation">
                <h3>Ventilation</h3>
            ...
            <div class="installation-container">
                <img src="./image/image-removebg-preview_7.png" alt="maintenance">
                <h3>Installation</h3>
            ...
            <div class="repair-container">
                <img src="./image/image-removebg-preview_8.png" alt="repair">
        ...
        <div class="container-appointment">
            <div class="logo">
                <img src="./image/logoo.png" alt="awes-logo">
            </div>
        ...
        <div class="popup" tabindex="0">
            <div class="popup-content">
                <img src="./image/cancel_FILL0_wght400_GRAD0_opsz24.png" alt="Close" class="close"
                    id="closeButton">
