                            ...
                            <div class="col">
                                <div class="d-grid gap2 d-md-flex justify-content-md-end">
                                    <button type="button" class="btn btn-warning me-md-2" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal">Complete Order</button>
                                    <button type="button" class="btn btn-danger me-md-2">Cancel Order</button>
                                    <button type="button" class="btn btn-primary me-md-2">Print</button>
                                </div>
                            </div>
                        </div>
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ route('index.purchaseOrder') }}" class="btn btn-primary">Yes</a>
                                    </div>
                                </div>
                            </div>
                        </div>
