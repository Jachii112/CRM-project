                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-4">
                                            ...
                                            <select class="form-select" id="customer_name" name="customer_name"
                                                ...
                                                @foreach ($getAppointmentData as $CustomerName)
                                                    <option value="{{ $CustomerName->customerName }}">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                customerName.addEventListener('change', () => {
                    const selectedName = customerName.value;
                    if (selectedName) {
                        fetch('/getCustomer/Data' + selectedName, {
                                method: 'GET',
                                headers: {
                            ...
                            .then(data => {
                                if (data) {
                                    document.getElementById('contact_no').value = data
                                        .phoneNumber;
