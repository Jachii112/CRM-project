                                ...
                                @foreach ($customerAppointment as $appointment)
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                            ...
                                            data-phonenumber="{{ $appointment->phoneNumber }}"
                                            data-customeremail="{{ $appointment->customerEmail }}">Register
                                            Customer</button>
                                    </td>
                                    </tr>
                                @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="confirmation" class="btn btn-primary confirm-button">Yes</button>
                </div>
            </div>
        </div>
    </div>
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            confirmButton.addEventListener('click', () => {
                // Get the customerName, phoneNumber, and customerEmail values from the modal
                const customerName = document.getElementById('exampleModal').getAttribute(
                    'data-customername');
                const phoneNumber = document.getElementById('exampleModal').getAttribute(
                'data-phonenumber');
                const customerEmail = document.getElementById('exampleModal').getAttribute(
                    'data-customeremail');
                ...
                window.location.href = "{{ route('add.customer.from.inbox') }}?customerName=" +
                    customerName + "&phoneNumber=" + phoneNumber + "&customerEmail=" + customerEmail;
            });
        });
    </script>
@endsection
